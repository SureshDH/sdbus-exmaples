...
struct Student s1[5] = {{514, "Dharavath Suresh", {90, 90, 90, 90, 90, 90}, 600, "Intro"},
						{515, "Nirosha Nani", {91, 91, 91, 91, 91, 91}, 601, "Introduc"},
						{516, "Sabitha Reddy", {92, 92, 92, 92, 92, 92}, 602, "Introduction"},
						{521, "Veena Reddy", {93, 93, 93, 93, 93, 93 }, 603, "Introduction to"},
						{522, "Upendar Reddy", {94, 94, 94, 94, 94, 94}, 604, "Introduction to SDBUS"}};
...
int main(int argc, char *argv[]) {
		...
		*/
		...
		r = sd_bus_message_new_method_call(bus,
										   ...
										   "net.poettering.Calculator",
										   "Astructa");
		r = sd_bus_message_open_container(m, 'a', "(isai(is))"); /*Open outer array*/
		for (i = 0; i < 5; i++) {
			r = sd_bus_message_open_container(m, 'r', "isai(is)"); /*Open structure element*/
			...
			r = sd_bus_message_open_container(m, 'r', "is"); /*Open structure element*/
