...
static int accept_astructa(sd_bus_message *m, void *userdata, sd_bus_error *ret_error) {
	...
	for(i=0; i<5; i++) {
			...
			r = sd_bus_message_read_array(m, 'i', &marks1, &length);
...
static const sd_bus_vtable calculator_vtable[] = {
        ...
        SD_BUS_METHOD("Astructa",   "a(isai)", "s", accept_astructa,   SD_BUS_VTABLE_UNPRIVILEGED),
        // SD_BUS_METHOD("Astructa",   "a(is)", "s", accept_astructa,   SD_BUS_VTABLE_UNPRIVILEGED),
        SD_BUS_VTABLE_END
};
