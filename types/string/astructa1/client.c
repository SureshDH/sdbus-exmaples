...
*/
struct Student s1[5] = {{{90, 90, 90, 90, 90, 90}, 514, "Dharavath Suresh"},
						{{91, 91, 91, 91, 91, 91}, 515, "Nirosha Nani"},
						{{93, 93, 93, 93, 93, 93}, 521, "Veena Reddy"},
						{{92, 92, 92, 92, 92, 92}, 516, "Sabitha Reddy"},
						{{94, 94, 94, 94, 94, 94}, 522, "Upendar Reddy"}};
