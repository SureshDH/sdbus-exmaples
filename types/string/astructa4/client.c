...
struct Student s1[5] = {{514, "Dharavath Suresh", {90, 90, 90, 90, 90, 90}, 600, "Intro", 123},
						{515, "Nirosha Nani", {91, 91, 91, 91, 91, 91}, 601, "Introduc", 124},
						{516, "Sabitha Reddy", {92, 92, 92, 92, 92, 92}, 602, "Introduction", 125},
						{521, "Veena Reddy", {93, 93, 93, 93, 93, 93 }, 603, "Introduction to", 126},
						{522, "Upendar Reddy", {94, 94, 94, 94, 94, 94}, 604, "Introduction to SDBUS", 127}};
...
int main(int argc, char *argv[]) {
		...
		*/
		...
		r = sd_bus_message_new_method_call(bus,
										   ...
										   "net.poettering.Calculator",
										   "Astructa");
		r = sd_bus_message_open_container(m, 'a', "(isai(is(i)))"); /*Open outer array*/
		for (i = 0; i < 5; i++) {
			r = sd_bus_message_open_container(m, 'r', "isai(is(i))"); /*Open structure element*/
			...
			// Book related
			r = sd_bus_message_open_container(m, 'r', "is(i)"); /*Open structure element*/
			r = sd_bus_message_append(m, "i", s1[i].b.pages);
			r = sd_bus_message_append(m, "s", s1[i].b.bookName);

			// Auther related
			r = sd_bus_message_open_container(m, 'r', "i"); /*Open structure element*/
			r = sd_bus_message_append(m, "i", s1[i].b.at.aid);
			r = sd_bus_message_close_container(m);
