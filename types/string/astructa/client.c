...
/*
struct Student s1[5] = {{514, {90, 90, 90, 90, 90, 90}, "Dharavath Suresh"},
						{515, {91, 91, 91, 91, 91, 91}, "Nirosha Nani"},
						{516, {92, 92, 92, 92, 92, 92}, "Sabitha Reddy"},
						{521, {93, 93, 93, 93, 93, 93}, "Veena Reddy"},
						{522, {94, 94, 94, 94, 94, 94}, "Upendar Reddy"}};
...
int main(int argc, char *argv[]) {
		...
		*/
		...
		r = sd_bus_message_new_method_call(bus,
										   ...
										   "net.poettering.Calculator",
										   "Astructa");
		r = sd_bus_message_open_container(m, 'a', "(isai)"); /*Open outer array*/
		for (i = 0; i < 5; i++) {
			r = sd_bus_message_open_container(m, 'r', "isai"); /*Open structure element*/
