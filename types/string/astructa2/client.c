...
struct Student s1[5] = {{514, "Dharavath Suresh", {90, 90, 90, 90, 90, 90}, 600},
						{515, "Nirosha Nani", {91, 91, 91, 91, 91, 91}, 601},
						{516, "Sabitha Reddy", {92, 92, 92, 92, 92, 92}, 602},
						{521, "Veena Reddy", {93, 93, 93, 93, 93, 93 }, 603},
						{522, "Upendar Reddy", {94, 94, 94, 94, 94, 94}, 604}};
