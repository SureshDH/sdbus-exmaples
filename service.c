...
static int accept_string(sd_bus_message *m, void *userdata, sd_bus_error *ret_error) {
	char string[1024];
	int r;
	...
	return sd_bus_message_new_method_return("This is the string in reponse", m);
	// return sd_bus_reply_method_return(m, "s", "This is the string in reponse");
}
...
static const sd_bus_vtable calculator_vtable[] = {
        ...
        SD_BUS_METHOD("String",   "s", "s", accept_string,   SD_BUS_VTABLE_UNPRIVILEGED),
        SD_BUS_VTABLE_END
};
